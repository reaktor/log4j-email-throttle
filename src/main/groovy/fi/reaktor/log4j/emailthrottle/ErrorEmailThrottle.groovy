...
public class ErrorEmailThrottle implements TriggeringEventEvaluator {
    ...
    public ErrorEmailThrottle() {
        this(
             ...
             getTimeIntervalPropertyInMilliSeconds("emailIntervalInSecs", 10 * 60),
             getTimeIntervalPropertyInMilliSeconds("normalAfterSecs", 30 * 60)
        )
    }

    public ErrorEmailThrottle(long throttleModeTriggerTimeMilliSecs, long throttledEmailIntervalMilliSecs,
            long throttleModeStopTimeMilliSecs) {
